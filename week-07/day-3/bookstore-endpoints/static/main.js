...
const catFilterBtn = document.querySelector('#get-cat-filters');
const catFilterDiv = document.querySelector('#div-cat-filters');

const costFilterBtn = document.querySelector('#get-cost-filters');
const costFilterDiv = document.querySelector('#div-cost-filters');
